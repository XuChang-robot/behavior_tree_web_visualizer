 ...
 */
export function exportAsPNG(filename = 'behavior_tree') {
    try {
        ...
        console.log('PNG导出成功:', filename, '尺寸:', width, 'x', height);
    } catch (error) {
        console.error('PNG导出失败:', error);
        eventBus.emit(Events.ERROR, { type: 'export', format: 'png', error });
        throw error;
    }
}
